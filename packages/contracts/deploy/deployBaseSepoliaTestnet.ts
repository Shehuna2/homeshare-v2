...
async function main() {
  ...
  allAddresses["base-sepolia"] = addresses;
  ...
  console.log(`   npx hardhat verify --network base-sepolia ${propertyTokenAddress} "Base Sepolia Property Token" "BSPT" "property-base-sepolia-1" "1000000000000000000000000" "100000000000000000000000"`);
  console.log(`   npx hardhat verify --network base-sepolia ${propertyCrowdfundAddress}`);
  console.log(`   npx hardhat verify --network base-sepolia ${chainRegistryAddress}`);
  console.log("\n2. Update frontend/backend with contract addresses");
  console.log("3. Test contract interactions on Base Sepolia testnet");
  console.log("=".repeat(50));
}
