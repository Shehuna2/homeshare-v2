...
async function main() {
  ...
  allAddresses.sepolia = addresses;
  ...
  console.log(`   npx hardhat verify --network sepolia ${propertyTokenAddress} "Sepolia Property Token" "SPT" "property-sepolia-1" "1000000000000000000000000" "100000000000000000000000"`);
  console.log(`   npx hardhat verify --network sepolia ${propertyCrowdfundAddress}`);
  console.log(`   npx hardhat verify --network sepolia ${chainRegistryAddress}`);
